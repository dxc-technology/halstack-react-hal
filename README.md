...
In addition to these component-specific properties you will also have all the properties of the Resultset Table component that can be found on [its site](https://developer.dxc.com/halstack/6/components/resultset-table/#props).
